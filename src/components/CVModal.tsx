...
import { X, Download, Briefcase, GraduationCap, Award, Mail, Phone, MapPin } from 'lucide-react';
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-6 mb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#01C9C7] text-black font-bold text-xs uppercase hover:bg-[#01C9C7]/80 transition-all cursor-pointer"
            >
